...
namespace mysqltest.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public ActionResult SchedulesAssignedInd(int id)
        {
            ...
            var query = owldb.course_schedule.Where(x => x.courses.course_id == id).ToList(); //HORARIOS ASIGNADOS AL CURSO PASADO POR PARÁMETRO
        ...
        public ActionResult TestsAssignedInd(int id)
        {
        ...
        public ActionResult EditTestAssignment(int id)
        {
            ...
            var query = owldb.module_vt.Where(x => x.module == id).FirstOrDefault();
        ...
        public ActionResult EditTestAssignment(module_vt mvt)
        {
            try
            {
                ...
                return RedirectToAction("TestsAssigned");
            }
            catch (Exception ex)
            {
                return View(mvt);
        ...
        public ActionResult DeleteTestAssignment(int id)
        {
            ...
            return RedirectToAction("TestsAssignedInd","Admin",new { id = query.module});
        }
        ...
        {
            var query = owldb.course_assignment.Where(x => x.course_id == id && x.schedule_id == schedule).ToList();
        ...
        {
            var query = owldb.course_assignment.Where(s => s.user_id == id).FirstOrDefault();
        ...
        {
            course_assignment ca = owldb.course_assignment.Where(s => s.user_id == csca.user_id).FirstOrDefault();
            ca.status = "1";
            owldb.SaveChanges();
            return RedirectToAction("IndexStudent", "User");
        }
